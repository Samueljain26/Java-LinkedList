...
public class StudentRecodManagement {
    public static void main(String[] args) {
        ...
        list.DeleteByRollnumber(106);

        list.printStudents();

        list.findStudent(101);

        list.updateStudentGrades('F',103);
...
Eve 105 21 B
Charlie 103 22 C
No SingleLinkedList.Student with given roll number exist
Alice 101 20 A
David 104 20 A
Bob 102 21 B
Eve 105 21 B
Charlie 103 22 C
SingleLinkedList.Student found
